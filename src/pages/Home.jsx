...
const Home = () => {
  ...
  return( 
    <div className="min-h-screen bg-[#8d1547]">
      ...
      <table className='w-full text-center'>
        ...
        {tableData.map((item,i) => (
           <tr>
             ...
             <td>{item.email}</td>
             <td>
              <button onClick={()=>handleEdit(i)} className='mr-3 text- bg-orange-400'>Edit</button>
              <button onClick={()=>handleDelete(i)} className='mr3 text-blue-400'>Delete</button>
             </td>
             </tr>
      ))}
